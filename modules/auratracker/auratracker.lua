...
function MODULE.Init()
	if not isInit and C.db.char.auratracker.enabled then
		...
		label:SetFont(LibStub("LibSharedMedia-3.0"):Fetch("font", C.db.global.fonts.font_2.font), C.db.global.fonts.font_2.size, C.db.global.fonts.font_2.outline and "OUTLINE" or nil)
