...
|cffdc4436Внимание!|r Многие параметры настроек панелей команд будут не доступны в этом режиме.|r]=]
L["RIGHT"] = "Право"
...
L["TARGET_INFO_DESC"] = "Показывать текущую цели цели в подсказке."
