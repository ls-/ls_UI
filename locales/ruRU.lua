...
L["CLOCK"] = "Часы"
L["COLOR_BY_SPEC"] = "Окрашивать в цвет спека"
...
L["DRAW_COOLDOWN_BLING"] = "Показывать мерцание перезарядки"
L["DRAW_COOLDOWN_BLING_DESC"] = "Показывать анимацию в конце перезарядки."
