...
L["TOOLTIP_UNIT_NAME_COLOR_DESC"] = "These options allow you to change flags that are used to resolve unit's name colour. |cffffd200They are listed in priority order.|r"
L["TOOLTIP_UNIT_NAME_COLOR_PVP"] = "PvP Hostility (Player Only)"
L["TOOLTIP_UNIT_NAME_COLOR_PVP_TOOLTIP"] = "|cffdc4436Hostile, can attack you\n|cffffb73cNot hostile, can be attacked\n|cff2eac34Friendly\n|cff1798fbCan't be attacked|r" -- M.COLORS.RED, M.COLORS.YELLOW, M.COLORS.GREEN, M.COLORS.BLUE
